...
echo ""
echo -e "Follow My Github Profile"
echo ""
...
echo "-------------------------------------------------------" | lolcat
echo   "Author   : DarkWinzo $white" |lolcat
echo   "Contact  : https://t.me/DarkWinzo $white" |lolcat
echo   "YouTube  : DarkWinzo $white" |lolcat
echo   "Github     : https://Github.com/DarkWinzo $white" |lolcat
echo "-------------------------------------------------------" | lolcat
echo "                           v2.0              " | lolcat
###################################################
# CTRL + C
...
echo -e "\e[1;101m\e[1;97m05\e[1;101m\e[0m\e[1;96m DARKPHISHER\e[0m\n";
...
echo -e "\e[1;101m\e[1;97m13\e[1;101m\e[0m\e[1;96m DARKVIRUS-MAKER\e[0m\n";
...
echo -e "\e[1;101m\e[1;97m16\e[1;101m\e[0m\e[1;96m CAMERAHACK\e[0m\n";
echo -e "\e[1;101m\e[1;97m17\e[1;101m\e[0m\e[1;96m INTA-HACK\e[0m\n";
...
case $pil in
01) clear
toilet -f standard " DarkWinzo " -F gay
...
17) clear
toilet -f standard "DarkWinzo" -F gay
git clone https://github.com/DarkWinzo/insta-Hack
cd insta-Hack
chmod +x *
bash setup.sh
bash instacracker.sh
...
00) echo "created by : DarkWinzo" | lolcat
exit
;;
